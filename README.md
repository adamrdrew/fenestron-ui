...
<!-- TOC -->autoauto- [Fenestron UI](#fenestron-ui)auto    - [Layout and Sizing](#layout-and-sizing)auto    - [Components](#components)auto        - [TitleBar](#titlebar)auto            - [Example](#example)auto            - [Props](#props)auto        - [Grid](#grid)auto            - [Example](#example-1)auto            - [Props](#props-1)auto        - [StackPanel](#stackpanel)auto            - [Props](#props-2)auto        - [SplitView](#splitview)auto            - [Inline Example](#inline-example)auto        - [Overlay Example](#overlay-example)auto            - [Props](#props-3)auto    - [PaneButton](#panebutton)auto            - [Props](#props-4)auto        - [BlurPanel](#blurpanel)auto        - [LayerPanel](#layerpanel)auto            - [Example: Modal-Like](#example-modal-like)auto            - [Example: Top Panel](#example-top-panel)auto            - [Example: Bottom Panel](#example-bottom-panel)auto            - [Example: Picture In Picture](#example-picture-in-picture)auto            - [Props](#props-5)auto        - [Pivot, PivotItem, & PivotContent](#pivot-pivotitem--pivotcontent)auto            - [Example:](#example)auto            - [Props](#props-6)auto        - [ParallexPanel](#parallexpanel)auto        - [GroupedList](#groupedlist)auto            - [Example:](#example-1)auto            - [Example with Item Template](#example-with-item-template)auto        - [CommandBar, AppBarButton, & AppBarSeperator](#commandbar-appbarbutton--appbarseperator)auto            - [Example:](#example-2)auto            - [Props](#props-7)auto            - [CommandBar Slots](#commandbar-slots)auto    - [TabView](#tabview)auto        - [Data Model and Custom Item Properties](#data-model-and-custom-item-properties)auto        - [Selected Item ID v-model](#selected-item-id-v-model)auto        - [Active vs Suspended Background Mode](#active-vs-suspended-background-mode)auto        - [Content Slot and Slot Props](#content-slot-and-slot-props)auto        - [Item Mutability](#item-mutability)auto        - [Drag and Drop Reordering](#drag-and-drop-reordering)auto    - [Tab Close Button](#tab-close-button)autoauto<!-- /TOC -->
...
### Data Model and Custom Item Properties
...
### Active vs Suspended Background Mode
